...
const SuspendPage = () => {
  ...
  const handleConfirmSuspend = async () => {
    ...
    try {
      ...
      const response = await suspendUserAccount(Number(userId));
    ...
    <div className="p-3">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex  flex-col items-center">
          <p className="font-ibmPlexSans font-semibold text-xl md:text-2xl md:mb-8 mb-4">Confirm Suspend</p>
          <p className="font-ibmPlexSans text-gray-500 font-normal text-base md:text-lg md:mb-4 mb-2">Select user to activate suspend button </p>
        </div>
        <div
        ...
        >
          ...
          <div className="flex flex-col gap-4 mb-5">
            ...
            <div className="flex items-center gap-3 p-1 bg-[#FFF7E8]" onClick={handleSuspendClick}>
        ...
        <div className=" flex mt-10 md:mt-36 gap-4">
          ...
          <button
            ...
            disabled={!isChecked}
            className={`px-9 md:px-14 py-1 text-white text-lg border border-[#FDAC15] ${!isChecked ? "bg-gray-400 cursor-not-allowed" : "bg-[#FDAC15]"} rounded-sm font-ibmPlexSans font-medium`}
          >
            Suspend
          </button>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-1/3">
            <p className="text-lg  text-black font-semibold mb-4">Are you sure you want to suspend this user?</p>
